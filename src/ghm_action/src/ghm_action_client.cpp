...
#include "/home/ghm/ros_study/devel/include/ghm_action/ghm_AddintAction.h"
/*  
    需求:
        创建两个ROS节点，服务器和客户端，
...
*/
typedef actionlib::SimpleActionClient<ghm_action::ghm_AddintAction> Client;


//处理最终结果
void done_cb(const actionlib::SimpleClientGoalState &state, const ghm_action::ghm_AddintResultConstPtr &result){
...
//处理连续反馈
void  feedback_cb(const ghm_action::ghm_AddintFeedbackConstPtr &feedback){
...
int main(int argc, char *argv[])
{
    ...
    */
    ghm_action::ghm_AddintGoal goal;
    goal.num = 100;
