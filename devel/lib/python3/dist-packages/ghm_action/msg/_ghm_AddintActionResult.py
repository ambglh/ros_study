...
"""autogenerated by genpy from ghm_action/ghm_AddintActionResult.msg. Do not edit."""
import codecs
import sys
...
class ghm_AddintActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "ghm_action/ghm_AddintActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ghm_action/ghm_AddintResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ghm_AddintActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ghm_action.msg.ghm_AddintResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ghm_action.msg.ghm_AddintResult()
