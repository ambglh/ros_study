...
class dowishGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.dishwasher_id, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new dowishGoal(null);
    // Deserialize message field [dishwasher_id]
    data.dishwasher_id = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new dowishGoal(null);
